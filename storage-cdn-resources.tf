# resource "azurerm_cdn_profile" "globant" {
#   name                = "globant-cdn"
...
# resource "azurerm_cdn_endpoint" "globant-end" {
#   name                = "globant-endpoint"
#   profile_name        = azurerm_cdn_profile.globant.name
#   location            = azurerm_resource_group.rg.location
#   resource_group_name = azurerm_resource_group.rg.name
